DELETE FROM tblAudio;

INSERT INTO tblAudio (id, artist, title, year, tracks, length, genre, recordlabel, language, mediatype, audioformat, barcode)
...
INSERT INTO tblVideo (id, title, year, originaltitle, director, genre, length, mediatype, language, audioformat, videoformat, barcode)
